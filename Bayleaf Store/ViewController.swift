...
class ViewController: UIViewController {
    ...
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Ai Technology"
        label.textColor = UIColor(hexString: "#b5651d")
    ...
    override func viewDidLoad() {
        ...
        backgrountNameViewTopConstraint = backgrountNameView.topAnchor.constraint(equalTo: viewBG.safeAreaLayoutGuide.topAnchor)
...
//            self.backgrountNameView.alpha = 0
